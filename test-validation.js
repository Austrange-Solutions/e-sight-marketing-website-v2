...
function testPhoneValidation() {
  ...
  const testCases = [
    { input: '9876543210', expected: 'valid', description: 'Valid 10-digit number' },
    { input: '8765432109', expected: 'valid', description: 'Valid starting with 8' },
    { input: '7654321098', expected: 'valid', description: 'Valid starting with 7' },
    { input: '6543210987', expected: 'valid', description: 'Valid starting with 6' },
    { input: '5432109876', expected: 'invalid', description: 'Invalid - starts with 5' },
    { input: '98765432', expected: 'invalid', description: 'Invalid - only 8 digits' },
    { input: '987654321011', expected: 'invalid', description: 'Invalid - 12 digits' },
    { input: '+919876543210', expected: 'valid', description: 'With country code (cleaned to 10 digits)' },
    { input: '98-7654-3210', expected: 'valid', description: 'With dashes (cleaned)' },
    { input: '(987) 654-3210', expected: 'valid', description: 'With formatting (cleaned)' },
  ];
  ...
  testCases.forEach(test => {
    ...
    console.log(`   Input: "${test.input}" → Cleaned: "${cleaned}" → ${result}`);
...
function testWordCountValidation() {
  ...
  testCases.forEach(test => {
    ...
    const wordCount = test.input.trim().split(/\s+/).filter(word => word.length > 0).length;
