          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {sections.map((section, index) => (
              <motion.button
                ...
                className="flex items-center p-4 bg-card rounded-lg shadow hover:shadow-md transition-shadow duration-300 text-left w-full"
              >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-3xl font-bold text-foreground">About e-Kaathi</h2>
            </div>
          ...
          >
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-3xl font-bold text-foreground">Information We Collect and How We Use It</h2>
            </div>
          ...
          >
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-3xl font-bold text-foreground">Detailed Permission Usage</h2>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="border border-blue-200 p-6 rounded-lg">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-foreground">Bluetooth Permissions</h3>
                </div>
                <div className="space-y-4">
                  <div>
                    <strong className="text-foreground">Permissions Required:</strong>
                    <ul className="list-disc list-inside ml-4 mt-2 space-y-1 text-foreground">
                      <li><code className="bg-accent px-2 py-1 rounded">BLUETOOTH</code></li>
                      <li><code className="bg-accent px-2 py-1 rounded">BLUETOOTH_ADMIN</code></li>
                      <li><code className="bg-accent px-2 py-1 rounded">BLUETOOTH_CONNECT</code></li>
                      <li><code className="bg-accent px-2 py-1 rounded">BLUETOOTH_SCAN</code></li>
                      <li><code className="bg-accent px-2 py-1 rounded">BLUETOOTH_PRIVILEGED</code></li>
                    </ul>
                  </div>
                  <div>
                    <strong className="text-foreground">Why We Need These:</strong>
                    <ul className="list-disc list-inside ml-4 mt-2 space-y-1 text-foreground">
              ...
              <div className="border border-green-200 p-6 rounded-lg">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-foreground">Location Permissions</h3>
                </div>
                <div className="space-y-4">
                  <div>
                    <strong className="text-foreground">Permissions Required:</strong>
                    <ul className="list-disc list-inside ml-4 mt-2 space-y-1 text-foreground">
                      <li><code className="bg-accent px-2 py-1 rounded">ACCESS_FINE_LOCATION</code></li>
                      <li><code className="bg-accent px-2 py-1 rounded">ACCESS_COARSE_LOCATION</code></li>
                      <li><code className="bg-accent px-2 py-1 rounded">ACCESS_BACKGROUND_LOCATION</code></li>
                    </ul>
                  </div>
                  <div>
                    <strong className="text-foreground">Why We Need These:</strong>
          ...
          >
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-3xl font-bold text-foreground">Data Security and Privacy Measures</h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-blue-50 p-6 rounded-lg">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-foreground">Local Storage Priority</h3>
                </div>
                <ul className="space-y-2 text-foreground">
              ...
              <div className="bg-purple-50 p-6 rounded-lg">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-foreground">Minimal Data Collection</h3>
                </div>
                <ul className="space-y-2 text-foreground">
          ...
          >
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-3xl font-bold text-foreground">Emergency SOS System</h2>
            </div>
            ...
            <div className="bg-red-50 border border-red-200 p-6 rounded-lg">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-4">Privacy During Emergencies:</h3>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-blue-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-foreground mb-4">✅ Sharing Control</h3>
                <ul className="space-y-2 text-foreground">
          ...
          >
            ...
            <div className="bg-accent p-8 rounded-lg">
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-4">📞 Privacy Questions or Concerns:</h3>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-4">🛡️ Data Protection Officer:</h3>
                  <div className="space-y-2 text-foreground">
                    <p><strong>Email:</strong> dpo@e-kaathi.com</p>
                    <p><strong>Role:</strong> Handles all privacy-related complaints and inquiries</p>
                  </div>
                  
                  <h3 className="text-lg font-semibold text-foreground mb-4 mt-6">🚨 Emergency Support:</h3>
                  <div className="space-y-2 text-foreground">
