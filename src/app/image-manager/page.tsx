          ...
          <div>
            <div className="mb-6">
              ...
              <p className="text-gray-600">
                Manage your uploaded images with search, filter, and bulk
                operations.
              </p>
            </div>
            <ImageGallery
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Upload images to AWS S3 with CloudFront CDN integration. Images
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Generate signed URLs for direct upload to AWS S3 (more
                  reliable).
                </p>
                <SignedUrlUploader
                  onUploadComplete={handleUploadComplete}
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              ...
              <ul className="text-sm text-blue-800 space-y-1">
                ...
                <li>
                  • Images are automatically optimized and served via CloudFront
                  CDN
                </li>
                <li>
                  • All uploads are automatically saved to the database with
                  metadata
                </li>
                <li>
                  • You can add descriptions, alt text, and tags after uploading
                </li>
              </ul>
            </div>
          </div>
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded">
                    ...
                    <span className="text-gray-600">
                      Fetch all images with filtering
                    </span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded">
