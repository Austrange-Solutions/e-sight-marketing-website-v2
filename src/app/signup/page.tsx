                ...
                <form className="mt-6 sm:mt-8 space-y-4 sm:space-y-6" onSubmit={(e) => { e.preventDefault(); onSignup(); }}>
                    ...
                    <div className="flex items-center">
                        ...
                        <label htmlFor="agree-terms" className="ml-2 block text-sm text-foreground">
                            I agree to the{' '}
                            <Link href="/terms-of-use" className="text-primary hover:text-primary/90">
                                Terms and Conditions
                            </Link>{' '}
                            and{' '}
                    ...
                    <div className="space-y-3">
                        ...
                        >
                            <svg className="h-5 w-5 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="800px" height="800px" viewBox="-0.5 0 48 48" version="1.1">
